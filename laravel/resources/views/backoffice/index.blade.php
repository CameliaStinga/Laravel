...
@section('content')
    ...
    <div class="uper">
        ...
        <a href="{{ route('categories.index')}}" class="btn btn-primary">Catégories</a>
        @foreach ($produit as $product)
            <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                    <a href="/product/{{$product-> id}}"> <img src="{{$product->picture}}" class="card-img-top"
                                                               alt="image"></a>
                ...
                @foreach($product->orders as $order)
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"> id: {{$order->id}} <br> nom:{{$order->number}} </li>
                    </ul>
                @endforeach
